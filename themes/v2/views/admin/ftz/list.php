...
<div class="table-toolbar">
    <div class="btn-group pull-left">
        <form class="form-inline">
            <div class="form-group">
                <?php echo CHtml::dropDownList('type',$type,array('title'=>'简体字'),array('class'=>'form-control','encode'=>false)); ?>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <?php echo CHtml::dropDownList('level',$level,Yii::app()->params['level'],array('class'=>'form-control chose_select','encode'=>false,'prompt'=>'--选择等级--')); ?>
            </div>
   ...
   <table class="table table-bordered table-striped table-condensed flip-content table-hover">
    ...
    <tr>
        ...
        <th class="text-center">简体字</th>
        <th class="text-center">繁体字</th>
    ...
    <?php foreach($infos as $k=>$v): ?>
        <tr>
            ...
            <td class="text-center"><?=$v->jtz?></td>
            <td class="text-center"><?=$v->correct?></td>
             <td class="text-center"><?=$v->level?Yii::app()->params['level'][$v->level]:'暂无'?></td>
