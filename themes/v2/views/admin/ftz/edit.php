...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'level', Yii::app()->params['level'], array('class' => 'form-control select2', 'encode' => false,'empty'=>'请选择')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'level') ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">简体字<span class="required" aria-required="true">*</span></label>
    <div class="col-md-4">
        <?php echo $form->textField($article, 'jtz', array('class' => 'form-control')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'jtz') ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">正确繁体字<span class="required" aria-required="true">*</span></label>
    <div class="col-md-4">
        <?php echo $form->textField($article, 'correct', array('class' => 'form-control')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'correct') ?></div>
</div>
<?php foreach (range(1, 6) as $key => $value) {?>
    <div class="form-group">
    <label class="col-md-2 control-label">繁体字<?=$value?><span class="required" aria-required="true">*</span></label>
    <div class="col-md-4">
        <?php echo $form->textField($article, 'ftz'.$value, array('class' => 'form-control')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'ftz'.$value) ?></div>
</div>
<?php } ?>
<div class="form-group">
